#ifndef MYSLAM_MODELS_GRAPH_OPTIMIZER_G2O_EDGE_EDGE_SE3_PRIORXYZ_HPP_
#define MYSLAM_MODELS_GRAPH_OPTIMIZER_G2O_EDGE_EDGE_SE3_PRIORXYZ_HPP_
...
public:
    ...
    void computeError() override {
        ...
        Eigen::Vector3d estimate = Eigen::Vector3d(v->estimate().translation());
