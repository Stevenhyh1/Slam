#ifndef MYSLAM_MODELS_GRAPH_OPTIMIZER_G2O_EDGE_EDGE_SE3_PRIORQUAT_HPP_
#define MYSLAM_MODELS_GRAPH_OPTIMIZER_G2O_EDGE_EDGE_SE3_PRIORQUAT_HPP_
...
public:
    ...
    void computeError() override {
        ...
        Eigen::Quaterniond estimate = Eigen::Quaterniond(v->estimate().linear());
        if (estimate.w() < 0) {
